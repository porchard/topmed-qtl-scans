...
# TODO: this is basically redundant with residualize.py; just need to detect the 4th column name and use it for the index. Not doing that now to avoid losing process caches
phenotypes_for_residualization = phenotypes.iloc[:,3:].set_index('ID')
